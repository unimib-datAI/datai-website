...
- Google Drive, cartella `Lavoro UNIMIB / Materiale per tesisti / Matteo Brunati / lab` — quattro fotografie archivistiche dello spazio di lavoro INSID&S (`inside2.jpg`, `inside3.jpg`, `inside3-2.jpg`, `miss.jpg`), tutte registrate su Drive nel novembre 2019. La Home le presenta esplicitamente come documentazione storica e non come roster corrente.
...
- Il 1 settembre 2026 l'utente ha confermato Carlo Batini come membro corrente del laboratorio. DISCo documenta che è stato professore alla Sapienza e a Milano-Bicocca fino al pensionamento nel 2019, oltre che Direttore del DISCo; il profilo Scholar verificato e il repository istituzionale BOA confermano la continuità dell'attività scientifica su qualità dei dati, modellazione concettuale, scienza dei servizi e sistemi informativi. Nel roster pubblico è presentato come senior member e professor (retired), senza attribuirgli uno status emerito non documentato.
- Il 1 settembre 2026 il profilo Google Scholar pubblico di Carlo Batini è stato estratto integralmente: 320 righe sorgente sono state ricondotte a 304 record distinti, dei quali 291 pubblicazioni incluse e 13 record esclusi come artefatti o attribuzioni errate. Crossref, OpenAlex, DBLP e DataCite sono usati solo per verificare identificatori e metadati; i record non confermati esternamente restano marcati come `scholar_only`.
- Il 31 agosto 2026 l'utente ha richiesto che tutti i ritratti del team fossero standardizzati tramite editing generativo identity-preserving: stesso formato 4:5, fondale studio petrolio, scala e posizione di testa e spalle, luce e maglietta nera girocollo, senza alterare i tratti identitari del volto. La preview privata usa WebP derivati dai master generati, conserva originali e crop precedenti fuori dalla cartella pubblica e registra fonti, metodo, prompt, checksum e stato dei diritti nella provenance; la conferma delle autorizzazioni resta un passaggio editoriale prima del lancio istituzionale pubblico.
